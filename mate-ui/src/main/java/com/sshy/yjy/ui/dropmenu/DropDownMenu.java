package com.sshy.yjy.ui.dropmenu;
...
public class DropDownMenu extends LinearLayout {
    ...
    //tab选中颜色
    private int textSelectedColor = 0xf5b847;
    //tab未选中颜色
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutParams params = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) (DeviceUtils.getScreenSize(getContext()).y * 0.05));
    ...
    private void addTab(@NonNull List<String> tabTexts, int i) {
        ...
        tab.setPadding(10, 0, dpTpPx(15), 0);
        //添加点击事件
