package com.sshy.yjy.ui.animation;
...
import com.sshy.yjy.ui.dimen.ScreenUtils;

public final class BezierAnimation {

    public static void addCart(AppCompatActivity activity, View start, View end,
        ...
        final ViewGroup anim_mask_layout = BezierUtil.createAnimLayout(activity);
        anim_mask_layout.addView(target);
        final View v = BezierUtil.addViewToAnimLayout(activity, target, startXY, true);
        if (v == null) {
            return;
        }
        /* 终点 */
        ...
        final  int my = ScreenUtils.getScreenHeight(activity) / 10;
