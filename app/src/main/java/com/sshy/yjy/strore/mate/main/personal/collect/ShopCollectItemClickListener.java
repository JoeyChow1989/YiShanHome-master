 ...
 * create by：周正尧
 */
public class ShopCollectItemClickListener extends SimpleClickListener {

    private final FragmentActivity DELEGATE;

    private ShopCollectItemClickListener(FragmentActivity delegate) {
        this.DELEGATE = delegate;
    }

    public static SimpleClickListener create(FragmentActivity delegate) {
        return new ShopCollectItemClickListener(delegate);
    }
