 ...
 * create by：周正尧
 */
public class VsPagersOrderAllDelegate extends MateDelegate implements ISuccess, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onSuccess(String response) {
        data = new OrderListDataConverter().setJsonData(response)
                .convert();
        adapter = new OrderListAdapter(data, getActivity());
        mRvOrderAll.setAdapter(adapter);
    }
