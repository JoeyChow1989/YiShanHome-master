 ...
 * create by：周正尧
 */
public class VsPagersOrderFinishedDelegate extends MateDelegate implements ISuccess, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onSuccess(String response) {
        data = new OrderFinishedDataConverter().setJsonData(response)
                .convert();
        final MateDelegate delegate = (MateDelegate) getParentFragment();
        adapter = new OrderFinishedAdapter(data, delegate);
        mRvOrderFinish.setAdapter(adapter);
