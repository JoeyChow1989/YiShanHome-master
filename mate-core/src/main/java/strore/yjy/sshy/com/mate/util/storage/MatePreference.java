package strore.yjy.sshy.com.mate.util.storage;
...
public final class MatePreference {
    ...
    private static final SharedPreferences PREFERENCES =
            PreferenceManager.getDefaultSharedPreferences(Mate.getApplicationContext());
